...
-- -----------------------------------------------------
-- Table `dw_trabalho_final_bd_ii`.`dimensao_tempo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dw_trabalho_final_bd_ii`.`dimensao_tempo` (
...
CREATE TABLE IF NOT EXISTS `dw_trabalho_final_bd_ii`.`pedido_fato` (
  ...
  `dimensao_tempo_id` INT NOT NULL,
  ...
  INDEX `fk_pedido_fato_dimensao_tempo1_idx` (`dimensao_tempo_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_pedido_fato_dimensao_tempo1`
    FOREIGN KEY (`dimensao_tempo_id`)
    REFERENCES `dw_trabalho_final_bd_ii`.`dimensao_tempo` (`id_tempo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
